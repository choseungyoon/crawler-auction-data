...
class Item(BaseModel):
    ...
    @classmethod
    def prisma(cls) -> 'actions.ItemActions':
        from .client import get_client

        return actions.ItemActions(get_client(), cls)
    ...
    def __init_subclass__(
        ...
        **kwargs: Any,
        ...
        if warn_subclass:
            _maybe_warn_subclassing(cls.__name__, 'Item', stacklevel=3)
    ...
    def create_partial(
        ...
        fields: Dict['types.ItemKeys', PartialModelField] = {}

        try:
            if include:
                for field in include:
                    fields[field] = _Item_fields[field]
            elif exclude:
...
_Item_fields: Dict['types.ItemKeys', PartialModelField] = {
    'id': {
        'name': 'id',
        'is_list': False,
        'optional': False,
