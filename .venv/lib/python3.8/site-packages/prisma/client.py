...
datasource db {
    provider = "mysql"
    url      = "mysql://127.0.0.1:3306/auction-market"
}
...
'''
SCHEMA_PATH = Path('/Users/seungyuncho/Project/crawler_auction_info/schema.prisma')
...
class Prisma:
    ...
    def __init__(
        ...
        *,
        ...
        self.item = actions.ItemActions(self, models.Item)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'mysql://127.0.0.1:3306/auction-market', 'fromEnvVar': None}).resolve(),
        }
