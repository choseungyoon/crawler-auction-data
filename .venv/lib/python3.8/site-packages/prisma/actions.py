...
class ItemActions:
    ...
    def __init__(self, client: 'Client', model: Type['models.Item']) -> None:
        self._client = client
        self._model = model
    ...
    async def query_first(
        ...
        *args
        ...
        user = await Item.prisma().query_first(
            'SELECT * FROM Item WHERE createdAt = ?',
    ...
    async def create(
        ...
        item = await Item.prisma().create(
            data={
                ...
                'caseNumber': 'dhheabfhf',
                'itemNumber': 'ggciceaie',
                'itemType': 'bbehjachib',
                'initialPrice': 24420185688,
                'minPrice': 4425610788,
                'bidType': 'bfaiacjjfc',
                'saleDate': datetime.datetime.utcnow(),
                'description': 'eigcfgbif',
                'itemLocation': 'bagcfbhiig',
                'court': 'cghideieh',
                'caseApplyDate': datetime.datetime.utcnow(),
                'auctionApplyDate': datetime.datetime.utcnow(),
                'allocationApplyDate': datetime.datetime.utcnow(),
                'requestPrice': 2162055696,
                'detailOfList': 'idghgaicb',
                'areaOfBuilding': 595337866.79042,
                'areaOfGround': 2111915288.114975,
                'appraisal': 'bgeecijdgg',
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await Item.prisma().create_many(
            data=[
                {
                    # data to create a Item record
                    'caseNumber': 'bdiicjafbj',
                    'itemNumber': 'bgehebiafc',
                    'itemType': 'bghffegacj',
                    'initialPrice': 21207296664,
                    'minPrice': 3915265380,
                    'bidType': 'bdedcabahc',
                    'saleDate': datetime.datetime.utcnow(),
                    'description': 'ghfhiafcb',
                    'itemLocation': 'heejgedji',
                    'court': 'bjgjgibgbf',
                    'caseApplyDate': datetime.datetime.utcnow(),
                    'auctionApplyDate': datetime.datetime.utcnow(),
                    'allocationApplyDate': datetime.datetime.utcnow(),
                    'requestPrice': 13394111568,
                    'detailOfList': 'igbehcbab',
                    'areaOfBuilding': 1303003706.168663,
                    'areaOfGround': 2000430152.186814,
                    'appraisal': 'bigaiehgcc',
                },
                {
                    # data to create a Item record
                    'caseNumber': 'beeifcbebf',
                    'itemNumber': 'bgcigfahea',
                    'itemType': 'bcejgaggif',
                    'initialPrice': 10030837464,
                    'minPrice': 9164637348,
                    'bidType': 'ecjjjfbae',
                    'saleDate': datetime.datetime.utcnow(),
                    'description': 'bhhfibbigf',
                    'itemLocation': 'ijdbeffgg',
                    'court': 'jjfeafhfj',
                    'caseApplyDate': datetime.datetime.utcnow(),
                    'auctionApplyDate': datetime.datetime.utcnow(),
                    'allocationApplyDate': datetime.datetime.utcnow(),
                    'requestPrice': 25232838288,
                    'detailOfList': 'chbfcacbd',
                    'areaOfBuilding': 456633834.205825,
                    'areaOfGround': 1583689592.87844,
                    'appraisal': 'bghfciaafe',
                },
            ],
    ...
    async def find_many(
        ...
        # find the first 5 Item records ordered by the updatedAt field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Item record ordered by the caseNumber field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Item records by minPrice values
